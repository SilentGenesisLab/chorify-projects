export const AUDIT_ACTION_LABELS: Record<string, string> = {
  ...
  CREATE_DEPLOYMENT: "发起发布",
  APPROVE_DEPLOYMENT: "审批发布",
  CREATE_ROLLBACK: "发起回滚",
  SUCCEED_DEPLOYMENT: "发布成功",
  FAIL_DEPLOYMENT: "发布失败",
  AUTO_ROLLBACK_DEPLOYMENT: "自动回滚",
  CHECK_DEPLOYMENT_HEALTH: "检测环境健康状态",
  UPDATE_DEPLOYMENT_CONFIG: "更新 CI/CD 配置",
  UPLOAD_FILE: "上传文件",
