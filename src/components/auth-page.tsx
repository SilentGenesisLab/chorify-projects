...
export function AuthPage({ page }: Props) {
  ...
  return <main className="grid min-h-screen bg-[#f4f7fb] lg:grid-cols-[1.05fr_.95fr]">
    ...
    <section className="flex items-center justify-center p-6 py-10"><div className="w-full max-w-[420px]">
      ...
      <p className="mt-6 text-center text-sm text-slate-500">{registering?"已经有账户？":"还没有账户？"} <Link href={registering?"/login":"/register"} className="font-semibold text-blue-600">{registering?"直接登录":"立即注册"}</Link></p>
